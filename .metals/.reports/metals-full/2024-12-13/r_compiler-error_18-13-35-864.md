file://<WORKSPACE>/webapp_Mille_Sabord/apps/jvm/src/test/scala/apps/app142/Tests.scala
### dotty.tools.dotc.core.TypeError$$anon$1: Toplevel definition newState is defined in
  <WORKSPACE>/webapp_Mille_Sabord/apps/jvm/src/main/scala/apps/app142/Logic.scala
and also in
  <WORKSPACE>/webapp_Mille_Sabord/apps/jvm/src/test/scala/apps/app142/Tests.scala
...
action parameters:
offset: 5980
uri: file://<WORKSPACE>/webapp_Mille_Sabord/apps/jvm/src/test/scala/apps/app142/Tests.scala
text:
```scala
package apps.app142
...
/// ## Selecting dice state
  ...
  test("MS: Playing state should forbid the player from choosing one skull dice"):
    ...
    val newState = selectDices(initi@@alState, Set(selectedDiceIdx))
