<<<<<<< HEAD:webapp_Mille_Sabord/apps/jvm/src/test/scala/apps/app142/Tests.scala
package apps.app142
...
/// ## Encoding and decoding
  ...
  test("MS: View wire"):
    ...
    do
      sm.project(s)(u).testViewWire
>>>>>>> d7480ff (Fixed the use of a random seed for the tests):webapp_Mille_Sabord/apps/jvm/src/test/scala/apps/rps/Tests.scala
