...
//============================= STATE VIEW WIRE =================================
  object StateViewFormat extends WireFormat[StateView]:
    override def encode(stateView: StateView): Value = 
      stateView match
        case StateView.Playing(phase:PhaseView, currentPlayer: UserId, diceView:Vector[DiceView], buttonView:Vector[ButtonView]) =>
          Obj("type" -> "Playing",
      ...
      js("type").str match
        case "Playing" =>
          StateView.Playing(
            ...
            VectorWire(DiceViewFormat).decode(js("diceView")).get,
...
//=============================== BUTTON VIEW WIRE ================================
  object ButtonViewFormat extends WireFormat[ButtonView]:
...
//============================== BUTTON ID WIRE ====================================
  object ButtonIdFormat extends WireFormat[ButtonType]:
...
//============================== DICE VIEW WIRE ====================================
  object DiceViewFormat extends WireFormat[DiceView]:
...
//============================== DICE WIRE ====================================
  object DiceFormat extends WireFormat[Dice]:
